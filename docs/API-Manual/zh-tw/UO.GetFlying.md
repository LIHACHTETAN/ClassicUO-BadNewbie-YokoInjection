...
Integer Boolean：1 = TRUE，0 = FALSE。可與數字或不加引號的邏輯常數比較。 mobile 具有 IsFlying 時回傳 1；否則或不存在時回傳 0。僅有高度 Z 並不表示飛行。
...
mobile 具有 IsFlying 時回傳 1；否則或不存在時回傳 0。僅有高度 Z 並不表示飛行。
...
# 檢查 mobile 是否飛行。
#
# Integer Boolean：1 = TRUE，0 = FALSE。可與數字或不加引號的邏輯常數比較。 mobile 具有 IsFlying 時回傳 1；否則或不存在時回傳 0。僅有高度
# Z 並不表示飛行。
#
