...
Integer Boolean：1 = TRUE，0 = FALSE。可與數字或不加引號的邏輯常數比較。 正值 serial 存在且未標記死亡時回傳 1。存在的物品也回傳 1，因此這不是 mobile 類型篩選。死亡或不存在的物件回傳 0。
...
正值 serial 存在且未標記死亡時回傳 1。存在的物品也回傳 1，因此這不是 mobile 類型篩選。死亡或不存在的物件回傳 0。
...
# 檢查物件是否存在且沒有死亡狀態。
#
# Integer Boolean：1 = TRUE，0 = FALSE。可與數字或不加引號的邏輯常數比較。 正值 serial 存在且未標記死亡時回傳 1。存在的物品也回傳 1，因此這不是
# mobile 類型篩選。死亡或不存在的物件回傳 0。
#
