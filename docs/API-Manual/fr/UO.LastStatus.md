...
Renvoie le serial du dernier objet dont le client a accepté le statut.
...
Integer — les 32 bits du serial, pas un type ni un booléen. 0 signifie aucun statut accepté ou un monde réinitialisé. Le bit de poids fort est conservé : un entier négatif peut aussi représenter un serial. Tester <> 0, pas > 0 ni = TRUE.
...
# Renvoie le serial du dernier objet dont le client a accepté le statut.
#
# Integer — les 32 bits du serial, pas un type ni un booléen. 0 signifie aucun statut accepté ou
# un monde réinitialisé. Le bit de poids fort est conservé : un entier négatif peut aussi
# représenter un serial. Tester <> 0, pas > 0 ni = TRUE.
