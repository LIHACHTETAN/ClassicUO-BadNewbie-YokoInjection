...
Vérifie un nom natif avec un nombre d’arguments.
...
- `argumentCount` — Integer obligatoire: nombre total d’arguments positionnels, y compris les facultatifs explicitement fournis. Nombre négatif/non accepté: 0. Les types ne sont pas vérifiés.
