...
- `ObjID` — Serial/ID facultatif du mobile : entier, chaîne hexadécimale, self, lasttarget, autre alias standard ou nom AddObject. Ce n’est pas un graphic/type. Sans argument, self est choisi. Un alias inconnu donne 0 ; aucun curseur de ciblage ne s’ouvre.
