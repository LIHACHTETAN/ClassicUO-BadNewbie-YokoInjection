...
Lit la valeur prévue de la coordonnée X après les pas déjà en file du joueur.
...
Integer X en cases de carte. 0 peut être une coordonnée réelle ou un joueur absent.
