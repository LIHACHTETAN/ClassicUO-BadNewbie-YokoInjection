...
- `CheckBoxID` — Integer — ID exact du type de contrôle concerné. Ce n’est ni un indice, ni un GumpID, ni le serial de la fenêtre. 0 est un ID ordinaire, jamais le premier contrôle par défaut.
