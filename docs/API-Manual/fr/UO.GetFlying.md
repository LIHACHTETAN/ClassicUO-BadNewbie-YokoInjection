...
Integer Boolean : 1 = TRUE, 0 = FALSE. Comparez avec des nombres ou des constantes logiques sans guillemets. 1 si le mobile a IsFlying ; sinon, ou s’il est absent, 0. La hauteur Z ne suffit pas à indiquer le vol.
...
1 si le mobile a IsFlying ; sinon, ou s’il est absent, 0. La hauteur Z ne suffit pas à indiquer le vol.
...
# sans guillemets. 1 si le mobile a IsFlying ; sinon, ou s’il est absent, 0. La hauteur Z ne
# suffit pas à indiquer le vol.
#
