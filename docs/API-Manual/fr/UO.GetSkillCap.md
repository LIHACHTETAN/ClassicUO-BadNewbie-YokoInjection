...
Lit le plafond de compétence reçu du serveur.
...
Decimal (Double) — points de compétence par dixièmes, par exemple 95,1 et non 951. Le champ CapFixed est divisé directement par 10 en Double. Zéro signifie une compétence à zéro ou un personnage/une compétence absent. Pas un Boolean. Les anciennes SkillVal/BaseVal utilisent une autre échelle ; ne mélangez pas ces familles.
...
# CapFixed est divisé directement par 10 en Double. Zéro signifie une compétence à zéro ou un
