...
Lit la valeur effective de la compétence avec modificateurs.
...
Decimal (Double) — points de compétence par dixièmes, par exemple 95,1 et non 951. Le champ ValueFixed est divisé directement par 10 en Double. Zéro signifie une compétence à zéro ou un personnage/une compétence absent. Pas un Boolean. Les anciennes SkillVal/BaseVal utilisent une autre échelle ; ne mélangez pas ces familles.
...
# ValueFixed est divisé directement par 10 en Double. Zéro signifie une compétence à zéro ou un
