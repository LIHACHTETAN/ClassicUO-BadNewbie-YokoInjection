...
Renvoie l’ID du personnage actuel.
...
Lit World.Player.Serial ; Player absent ou détruit donne 0. Mort et destruction diffèrent : un fantôme présent garde son ID. Invoke lit dans le thread du jeu ; un thread de travail attend le traitement par le gestionnaire. L’annulation du script interrompt cette attente. Aucun délai ni appel réseau supplémentaire.
...
# pas à jour seule. Lit World.Player.Serial ; Player absent ou détruit donne 0. Mort et
# destruction diffèrent : un fantôme présent garde son ID.
