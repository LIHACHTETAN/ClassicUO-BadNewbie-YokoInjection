...
Vérifie si un mobile est empoisonné.
...
Integer Boolean : 1 = TRUE, 0 = FALSE. Comparez avec des nombres ou des constantes logiques sans guillemets. 1 si le mobile a IsPoisoned ; sinon, ou s’il est absent, 0. La puissance du poison et sa durée restante ne sont pas renvoyées.
...
- Poisoned/Flying dépendent du protocole : avant 7.0.0.0, le bit 0x04 indique le poison ; dès 7.0.0.0, il indique le vol et le poison est conservé séparément. Le vol n’est pas déduit de Z.
...
1 si le mobile a IsPoisoned ; sinon, ou s’il est absent, 0. La puissance du poison et sa durée restante ne sont pas renvoyées.
...
# sans guillemets. 1 si le mobile a IsPoisoned ; sinon, ou s’il est absent, 0. La puissance du
# poison et sa durée restante ne sont pas renvoyées.
#
