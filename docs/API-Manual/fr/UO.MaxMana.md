...
Lit la mana maximale dans le modèle local.
...
# Lit la mana maximale dans le modèle local.
#
# Integer — valeur du champ ManaMax, pas un pourcentage ni un Boolean. Zéro peut être une valeur
