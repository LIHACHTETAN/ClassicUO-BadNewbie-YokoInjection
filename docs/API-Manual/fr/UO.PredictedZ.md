...
Lit la valeur prévue de la hauteur Z après les pas déjà en file du joueur.
...
Integer Z signé -128..127 ; les hauteurs négatives sont conservées. 0 peut être réel ou indiquer un joueur absent.
...
# Lit la valeur prévue de la hauteur Z après les pas déjà en file du joueur.
#
# Integer Z signé -128..127 ; les hauteurs négatives sont conservées. 0 peut être réel ou
# indiquer un joueur absent.
