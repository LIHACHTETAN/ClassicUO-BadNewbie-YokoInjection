...
Lit la mana actuelle dans le modèle local.
...
# Lit la mana actuelle dans le modèle local.
#
# Integer — valeur du champ Mana, pas un pourcentage ni un Boolean. Zéro peut être une valeur
