...
Integer Boolean : 1 = TRUE, 0 = FALSE. Comparez avec des nombres ou des constantes logiques sans guillemets. 1 si le mobile a IsDead ; sinon, ou si le mobile est absent, 0. HP=0 seul ne signifie pas la mort.
...
1 si le mobile a IsDead ; sinon, ou si le mobile est absent, 0. HP=0 seul ne signifie pas la mort.
...
# sans guillemets. 1 si le mobile a IsDead ; sinon, ou si le mobile est absent, 0. HP=0 seul ne
# signifie pas la mort.
#
