...
ClassicUO • Runtime API • `UO.IsWaterTile.md`
...
- `UO.IsWaterTile(x:Integer, y:Integer) -> Integer`
  - **Return type:** `Integer`
...
```vb
SUB Main()
    VAR result = UO.IsWaterTile(UO.GetX(), UO.GetY())
...
SUB Main()
    VAR arg1 = UO.GetX() # x
    VAR arg2 = UO.GetY() # y
    VAR result = UO.IsWaterTile(arg1, arg2)
...
- `InjectionScript.Runtime.InjectionApiUO.IsWaterTile`
