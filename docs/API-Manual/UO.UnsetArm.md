...
ClassicUO • Runtime API • `UO.UnsetArm.md`
...
- `name` — Named runtime value (String); use the exact registered/saved name expected by UnsetArm.
...
- `InjectionScript.Runtime.InjectionApiUO.UnsetArm`
