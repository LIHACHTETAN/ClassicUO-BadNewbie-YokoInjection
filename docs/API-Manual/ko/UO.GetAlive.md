...
Integer Boolean: 1 = TRUE, 0 = FALSE입니다. 숫자 또는 따옴표 없는 논리 상수와 비교할 수 있습니다. 양수 serial이 존재하고 사망 표시가 없으면 1입니다. 존재하는 아이템도 1을 반환하므로 mobile 유형 필터가 아닙니다. 사망하거나 없는 객체는 0입니다.
...
양수 serial이 존재하고 사망 표시가 없으면 1입니다. 존재하는 아이템도 1을 반환하므로 mobile 유형 필터가 아닙니다. 사망하거나 없는 객체는 0입니다.
...
# 사망 상태가 없는 객체의 존재를 확인합니다.
#
# Integer Boolean: 1 = TRUE, 0 = FALSE입니다. 숫자 또는 따옴표 없는 논리 상수와 비교할 수 있습니다. 양수 serial이 존재하고 사망
# 표시가 없으면 1입니다. 존재하는 아이템도 1을 반환하므로 mobile 유형 필터가 아닙니다. 사망하거나 없는 객체는 0입니다.
#
