...
마지막 검색에서 첫 번째 객체의 serial을 읽습니다.
...
Integer — 첫 번째 객체의 serial/ID이며, 결과가 없으면 0입니다. graphic/type이 아닙니다. FindType과 달리 16진수 문자열이 아닌 숫자를 반환합니다.
...
# 마지막 검색에서 첫 번째 객체의 serial을 읽습니다.
#
# Integer — 첫 번째 객체의 serial/ID이며, 결과가 없으면 0입니다. graphic/type이 아닙니다. FindType과 달리 16진수 문자열이 아닌
# 숫자를 반환합니다.
