...
Integer — serial/ID이며 type이나 Boolean이 아닙니다. 0은 객체 대상 없음입니다. 지면/정적 대상도 좌표를 저장할 수 있지만 serial은 0입니다. 32비트를 보존합니다. > 0이나 = TRUE 대신 <> 0을 확인합니다.
...
# 마지막으로 저장한 객체 대상의 serial을 읽습니다.
#
# Integer — serial/ID이며 type이나 Boolean이 아닙니다. 0은 객체 대상 없음입니다. 지면/정적 대상도 좌표를 저장할 수 있지만 serial은
# 0입니다. 32비트를 보존합니다. > 0이나 = TRUE 대신 <> 0을 확인합니다.
