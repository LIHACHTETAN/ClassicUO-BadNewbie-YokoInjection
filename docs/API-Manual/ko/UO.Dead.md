...
Integer Boolean: 1 = TRUE, 0 = FALSE입니다. 숫자 또는 따옴표 없는 논리 상수와 비교할 수 있습니다. mobile에 IsDead가 있으면 1, 없거나 mobile이 없으면 0입니다. HP=0만으로 사망을 판단하지 않습니다.
...
mobile에 IsDead가 있으면 1, 없거나 mobile이 없으면 0입니다. HP=0만으로 사망을 판단하지 않습니다.
...
# mobile의 사망 상태를 확인합니다.
#
# Integer Boolean: 1 = TRUE, 0 = FALSE입니다. 숫자 또는 따옴표 없는 논리 상수와 비교할 수 있습니다. mobile에 IsDead가 있으면
# 1, 없거나 mobile이 없으면 0입니다. HP=0만으로 사망을 판단하지 않습니다.
#
