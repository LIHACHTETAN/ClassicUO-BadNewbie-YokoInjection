...
ClassicUO • Runtime API • `UO.IsMineTile.md`
...
- `UO.IsMineTile(x:Integer, y:Integer) -> Integer`
  - **Return type:** `Integer`
...
```vb
SUB Main()
    VAR result = UO.IsMineTile(UO.GetX(), UO.GetY())
...
SUB Main()
    VAR arg1 = UO.GetX() # x
    VAR arg2 = UO.GetY() # y
    VAR result = UO.IsMineTile(arg1, arg2)
...
- `InjectionScript.Runtime.InjectionApiUO.IsMineTile`
