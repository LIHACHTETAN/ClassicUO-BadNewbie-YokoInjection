...
ClassicUO • Runtime API • `UO.GetFlags.md`
...
- `UO.GetFlags(id:ObjectRef) -> Integer`
  - **Return type:** `Integer`
...
- `InjectionScript.Runtime.InjectionApiUO.GetFlags`
