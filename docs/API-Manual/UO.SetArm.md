...
ClassicUO • Runtime API • `UO.SetArm.md`
...
- `name` — Named runtime value (String); use the exact registered/saved name expected by SetArm.
...
- `InjectionScript.Runtime.InjectionApiUO.SetArm`
