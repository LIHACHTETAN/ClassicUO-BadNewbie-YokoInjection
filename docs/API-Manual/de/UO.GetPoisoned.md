...
Prüft, ob ein Mobile vergiftet ist.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Zahlen oder logische Konstanten ohne Anführungszeichen sind vergleichbar. 1 bedeutet IsPoisoned beim Mobile; sonst oder ohne Mobile 0. Giftstärke und Restdauer werden nicht geliefert.
...
1 bedeutet IsPoisoned beim Mobile; sonst oder ohne Mobile 0. Giftstärke und Restdauer werden nicht geliefert.
...
# sind vergleichbar. 1 bedeutet IsPoisoned beim Mobile; sonst oder ohne Mobile 0. Giftstärke und
# Restdauer werden nicht geliefert.
#
...
SUB Main()
    ...
    VAR before = UO.GetPoisoned()
    WAIT(500)
    VAR after = UO.GetPoisoned()
