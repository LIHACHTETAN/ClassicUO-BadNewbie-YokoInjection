...
Liest die vom Server empfangene Fertigkeitsobergrenze.
...
Decimal (Double) — Fertigkeitspunkte in Zehnteln, etwa 95,1 statt 951. Feld CapFixed wird direkt als Double durch 10 geteilt. Null bedeutet Nullwert oder fehlenden Charakter/fehlende Fertigkeit. Kein Boolean. Alte SkillVal/BaseVal nutzen eine andere Skala; Familien nicht vermischen.
...
# Liest die vom Server empfangene Fertigkeitsobergrenze.
#
# Decimal (Double) — Fertigkeitspunkte in Zehnteln, etwa 95,1 statt 951. Feld CapFixed wird
