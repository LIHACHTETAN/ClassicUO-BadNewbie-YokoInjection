...
Liest das Widerstandsfeld des aktuellen Spielers: Energie.
...
- Liest Player.EnergyResistance im Spielthread, sofern Player vorhanden und nicht zerstört ist; sonst 0. Keine Ausrüstungssuche, Bonusberechnung, Statusanforderung oder Wartezeit. Ein vorhandener Geist ist kein zerstörter Player.
