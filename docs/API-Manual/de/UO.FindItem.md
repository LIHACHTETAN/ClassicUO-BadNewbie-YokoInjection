...
Liest die serial des ersten Objekts der letzten Suche.
...
Integer — serial/ID des ersten Objekts, ohne Ergebnis 0. Kein graphic/type. Anders als FindType liefert dies eine Zahl statt einer hexadezimalen Zeichenfolge.
...
# Liest die serial des ersten Objekts der letzten Suche.
#
# Integer — serial/ID des ersten Objekts, ohne Ergebnis 0. Kein graphic/type. Anders als
# FindType liefert dies eine Zahl statt einer hexadezimalen Zeichenfolge.
