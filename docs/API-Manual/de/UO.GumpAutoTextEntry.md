...
- `TextEntryID` — Integer — genaue ID des betreffenden Steuerelementtyps. Kein Index, keine GumpID und keine Fenster-Serial. 0 ist eine gewöhnliche ID und wählt nicht ersatzweise das erste Element.
- `Value` — String — Feldtext; eine leere Zeichenfolge leert das Feld. Längen- und Zeichenbeschränkungen des Feldes bleiben bestehen.
...
- Ein Feld kann Text kürzen oder ablehnen; das gefundene Element verbraucht die Aktion dennoch. Der Befehl sendet keine Schaltflächenantwort und wartet nicht auf den Server. Text mit GetGumpInfo/NumGumpTextEntry prüfen.
