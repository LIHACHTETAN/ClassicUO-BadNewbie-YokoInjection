...
Liefert die gespeicherte Y-Koordinate des zuletzt angenommenen Statusobjekts.
...
Integer — gespeicherte Y-Koordinate, kein Fensterpixel und kein Boolean. Vor dem ersten Status oder nach dem Leeren 0; auch eine echte Koordinate darf 0 sein. Fehlende Daten mit UO.LastStatus() unterscheiden.
...
Projektquelle: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; Funktion `LastStatusY`.
...
# Liefert die gespeicherte Y-Koordinate des zuletzt angenommenen Statusobjekts.
#
# Integer — gespeicherte Y-Koordinate, kein Fensterpixel und kein Boolean. Vor dem ersten Status
