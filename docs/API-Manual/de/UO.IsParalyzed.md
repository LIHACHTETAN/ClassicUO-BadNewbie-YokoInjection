...
- `ObjID` — Optionale Serial/ID des Mobiles: Ganzzahl, Hex-Zeichenkette, self, lasttarget, anderer Standardalias oder AddObject-Name. Kein graphic/type. Ohne Argument wird self gewählt. Ein unbekannter Alias ergibt 0; es erscheint kein Zielcursor.
