...
Liest das Widerstandsfeld des aktuellen Spielers: physische Rüstung/Widerstand.
...
- Liest Player.PhysicalResistance im Spielthread, sofern Player vorhanden und nicht zerstört ist; sonst 0. Keine Ausrüstungssuche, Bonusberechnung, Statusanforderung oder Wartezeit. Ein vorhandener Geist ist kein zerstörter Player.
...
SUB Main()
    ...
    VAR before = UO.ResistPhysical()
    WAIT(500)
    VAR after = UO.ResistPhysical()
