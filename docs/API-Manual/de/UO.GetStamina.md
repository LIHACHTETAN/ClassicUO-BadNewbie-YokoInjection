...
Liest die aktuelle Ausdauer aus dem lokalen Modell.
...
Integer — Feldwert Stamina, kein Prozentsatz und kein Boolean. Null kann ein echter Wert oder fehlende Information sein. Nie durch ein Maximum von null teilen. Werte anderer Mobiles können unbekannt sein. HP/HitsMax können eine relative Serverskala statt exakter Punkte enthalten. HP=0 beweist keinen Tod; dafür Dead/IsDead verwenden.
...
# Liest die aktuelle Ausdauer aus dem lokalen Modell.
#
# Integer — Feldwert Stamina, kein Prozentsatz und kein Boolean. Null kann ein echter Wert oder
