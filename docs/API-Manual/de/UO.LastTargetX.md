...
Liest X, gespeichert bei der letzten Zielwahl.
...
Integer — gespeicherte X-Koordinate, kein Pixel oder Boolean. Vor Auswahl/nach Clear oder bei unbekanntem Objekt 0; auch echte Koordinaten dürfen 0 sein. Boden/Statik funktionieren bei LastTarget()=0.
...
Projektquelle: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; Funktion `LastTargetX`.
...
# Liest X, gespeichert bei der letzten Zielwahl.
#
# Integer — gespeicherte X-Koordinate, kein Pixel oder Boolean. Vor Auswahl/nach Clear oder bei
