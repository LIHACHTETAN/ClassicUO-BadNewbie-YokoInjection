...
Integer Boolean: 1 = TRUE, 0 = FALSE. Zahlen oder logische Konstanten ohne Anführungszeichen sind vergleichbar. 1 bedeutet IsDead beim Mobile; sonst oder ohne Mobile 0. HP=0 allein bedeutet nicht Tod.
...
1 bedeutet IsDead beim Mobile; sonst oder ohne Mobile 0. HP=0 allein bedeutet nicht Tod.
...
# sind vergleichbar. 1 bedeutet IsDead beim Mobile; sonst oder ohne Mobile 0. HP=0 allein
# bedeutet nicht Tod.
#
