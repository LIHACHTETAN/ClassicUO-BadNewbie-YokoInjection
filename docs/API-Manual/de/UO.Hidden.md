...
Prüft, ob ein Mobile verborgen ist.
...
- `idText` — Optionales Objekt in den gezeigten Formen: numerischer serial, Hex-Zeichenfolge, self, lasttarget oder registrierter AddObject-Name. Kein type. Ohne Argument wird self gelesen. Unbekannter Text verursacht in manchen Formen einen Konvertierungsfehler; den Namen vorher prüfen.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Zahlen oder logische Konstanten ohne Anführungszeichen sind vergleichbar. 1 bedeutet IsHidden beim Mobile; sonst oder ohne Mobile 0. Das ist ein Serverflag, keine Sichtprüfung durch Wände.
...
1 bedeutet IsHidden beim Mobile; sonst oder ohne Mobile 0. Das ist ein Serverflag, keine Sichtprüfung durch Wände.
...
# sind vergleichbar. 1 bedeutet IsHidden beim Mobile; sonst oder ohne Mobile 0. Das ist ein
# Serverflag, keine Sichtprüfung durch Wände.
#
