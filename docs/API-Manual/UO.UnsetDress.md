...
ClassicUO • Runtime API • `UO.UnsetDress.md`
...
- `name` — Named runtime value (String); use the exact registered/saved name expected by UnsetDress.
...
- `InjectionScript.Runtime.InjectionApiUO.UnsetDress`
