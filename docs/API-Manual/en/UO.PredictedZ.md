...
Reads the predicted Z height after the player’s currently queued movement steps.
...
Integer Z height, signed -128..127; negative heights are preserved. 0 is a valid height or missing-player result.
...
# Reads the predicted Z height after the player’s currently queued movement steps.
#
# Integer Z height, signed -128..127; negative heights are preserved. 0 is a valid height or
# missing-player result.
