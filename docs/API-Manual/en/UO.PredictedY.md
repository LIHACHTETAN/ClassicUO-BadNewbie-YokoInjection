...
Reads the predicted Y coordinate after the player’s currently queued movement steps.
...
Integer Y in map tiles. 0 is a valid coordinate or missing-player result.
