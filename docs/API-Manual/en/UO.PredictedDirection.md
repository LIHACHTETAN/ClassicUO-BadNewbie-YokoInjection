...
Reads the predicted direction after the player’s currently queued movement steps.
...
Integer direction 0..7, with the running bit removed. 0 means north, or a missing player.
...
- World directions: 0 north, 1 north-east, 2 east, 3 south-east, 4 south, 5 south-west, 6 west, 7 north-west. Screen axes are isometric. Direction.Mask removes the running flag; no speed is returned.
