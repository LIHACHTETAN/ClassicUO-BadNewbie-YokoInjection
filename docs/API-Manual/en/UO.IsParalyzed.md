...
- `ObjID` — Optional mobile serial/ID: integer, hexadecimal string, self, lasttarget, another standard object alias or an AddObject name. This is not graphic/type. Omit it to select self. An unresolved alias becomes 0; no target cursor is opened.
