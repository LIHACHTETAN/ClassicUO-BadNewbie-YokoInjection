...
- `CheckBoxID` — Integer — exact ID of the corresponding control type. Not an index, GumpID or window serial. 0 is an ordinary ID and never means the first control.
