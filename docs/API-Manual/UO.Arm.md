...
ClassicUO • Runtime API • `UO.Arm.md`
...
- `name` — Named runtime value (String); use the exact registered/saved name expected by Arm.
...
- `InjectionScript.Runtime.InjectionApiUO.Arm`
