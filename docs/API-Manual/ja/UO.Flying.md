...
Integer Boolean：1 = TRUE、0 = FALSE。数値または引用符のない論理定数と比較できます。 mobile が IsFlying なら 1、それ以外または不在なら 0。高さ Z だけでは飛行とは判断しません。
...
mobile が IsFlying なら 1、それ以外または不在なら 0。高さ Z だけでは飛行とは判断しません。
...
# mobile が飛行しているか調べます。
#
# Integer Boolean：1 = TRUE、0 = FALSE。数値または引用符のない論理定数と比較できます。 mobile が IsFlying なら 1、それ以外または不在なら
# 0。高さ Z だけでは飛行とは判断しません。
#
