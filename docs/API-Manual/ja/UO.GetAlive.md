...
Integer Boolean：1 = TRUE、0 = FALSE。数値または引用符のない論理定数と比較できます。 正の serial が存在し、死亡扱いでなければ 1。存在するアイテムも 1 を返すため、mobile の種類フィルターではありません。死亡または不在なら 0。
...
正の serial が存在し、死亡扱いでなければ 1。存在するアイテムも 1 を返すため、mobile の種類フィルターではありません。死亡または不在なら 0。
...
# 死亡状態のない物体が存在するか調べます。
#
# Integer Boolean：1 = TRUE、0 = FALSE。数値または引用符のない論理定数と比較できます。 正の serial が存在し、死亡扱いでなければ
# 1。存在するアイテムも 1 を返すため、mobile の種類フィルターではありません。死亡または不在なら 0。
#
