...
Lee la mana actual del modelo local.
...
# Lee la mana actual del modelo local.
#
# Integer — valor del campo Mana, no un porcentaje ni un Boolean. Cero puede ser un valor real o
