...
Lee la mana máxima del modelo local.
...
# Lee la mana máxima del modelo local.
#
# Integer — valor del campo ManaMax, no un porcentaje ni un Boolean. Cero puede ser un valor
