...
- `ObjID` — Serial/ID opcional del mobile: entero, cadena hexadecimal, self, lasttarget, otro alias estándar o nombre AddObject. No es graphic/type. Sin argumento se elige self. Un alias desconocido da 0; no abre un cursor de selección.
