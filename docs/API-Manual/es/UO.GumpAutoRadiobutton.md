...
- `RadiobuttonID` — Integer — ID exacto del tipo de control correspondiente. No es índice, GumpID ni serial de ventana. 0 es un ID normal, sin selección automática del primer control.
