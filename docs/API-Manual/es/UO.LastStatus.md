...
Devuelve el serial del último objeto cuyo estado aceptó el cliente.
...
Integer — los 32 bits del serial, no un type ni un Boolean. 0 significa que aún no se aceptó un estado o se limpió el mundo. Conserva el bit superior: un entero negativo también puede representar un serial. Comprobar <> 0, no > 0 ni = TRUE.
...
# Devuelve el serial del último objeto cuyo estado aceptó el cliente.
#
# Integer — los 32 bits del serial, no un type ni un Boolean. 0 significa que aún no se aceptó
# un estado o se limpió el mundo. Conserva el bit superior: un entero negativo también puede
# representar un serial. Comprobar <> 0, no > 0 ni = TRUE.
