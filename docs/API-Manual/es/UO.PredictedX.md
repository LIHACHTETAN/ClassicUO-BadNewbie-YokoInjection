...
Lee el valor previsto de la coordenada X tras los pasos del jugador ya en cola.
...
Integer X en casillas del mapa. 0 puede ser una coordenada válida o jugador ausente.
