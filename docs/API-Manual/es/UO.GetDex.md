...
Lee la Destreza actual (Dexterity, DEX).
...
- Lee Player.Dexterity si Player existe y no está destruido; en caso contrario, 0. Un personaje muerto presente no es un objeto destruido. No se deduce de HP, maná o resistencia.
...
- Nombres equivalentes con y sin UO., sin distinguir mayúsculas: `Dex Dexterity GetDex GetDexterity`.
...
CharacterStatus asigna el campo STR/DEX/INT recibido a Player.Dexterity al procesar un paquete status propio aplicable. La consulta lee la caché sin esperar otro paquete.
