...
Lee el valor efectivo de la habilidad con modificadores.
...
Decimal (Double) — puntos de habilidad en décimas, por ejemplo 95,1 en lugar de 951. El campo ValueFixed se divide directamente entre 10 en Double. Cero significa habilidad cero o personaje/habilidad ausente. No es Boolean. Las antiguas SkillVal/BaseVal usan otra escala; no mezcle las familias.
...
# ValueFixed se divide directamente entre 10 en Double. Cero significa habilidad cero o
