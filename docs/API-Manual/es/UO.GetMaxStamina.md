...
Lee la resistencia máxima del modelo local.
...
# Lee la resistencia máxima del modelo local.
#
# Integer — valor del campo StaminaMax, no un porcentaje ni un Boolean. Cero puede ser un valor
