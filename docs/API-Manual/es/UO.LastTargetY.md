...
Lee Y guardada al seleccionar el último objetivo.
...
Integer — coordenada Y guardada, no píxel ni Boolean. 0 antes de seleccionar/después de Clear o para objetos desconocidos; cero también es válido. Funciona para terreno/estáticos con LastTarget()=0.
...
Código del proyecto: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; función `LastTargetY`.
...
# Lee Y guardada al seleccionar el último objetivo.
#
# Integer — coordenada Y guardada, no píxel ni Boolean. 0 antes de seleccionar/después de Clear
