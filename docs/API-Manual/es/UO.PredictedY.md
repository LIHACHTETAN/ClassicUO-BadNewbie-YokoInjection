...
Lee el valor previsto de la coordenada Y tras los pasos del jugador ya en cola.
...
Integer Y en casillas del mapa. 0 puede ser una coordenada válida o jugador ausente.
