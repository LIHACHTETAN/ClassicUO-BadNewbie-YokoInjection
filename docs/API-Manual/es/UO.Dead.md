...
Comprueba si un mobile está muerto.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Puede compararse con números o constantes lógicas sin comillas. 1 indica IsDead en el mobile; en caso contrario, o si no existe, 0. HP=0 por sí solo no significa muerte.
...
1 indica IsDead en el mobile; en caso contrario, o si no existe, 0. HP=0 por sí solo no significa muerte.
...
# comillas. 1 indica IsDead en el mobile; en caso contrario, o si no existe, 0. HP=0 por sí solo
# no significa muerte.
#
