...
Lee el valor base de la habilidad sin modificadores.
...
Decimal (Double) — puntos de habilidad en décimas, por ejemplo 95,1 en lugar de 951. El campo BaseFixed se divide directamente entre 10 en Double. Cero significa habilidad cero o personaje/habilidad ausente. No es Boolean. Las antiguas SkillVal/BaseVal usan otra escala; no mezcle las familias.
...
# BaseFixed se divide directamente entre 10 en Double. Cero significa habilidad cero o
