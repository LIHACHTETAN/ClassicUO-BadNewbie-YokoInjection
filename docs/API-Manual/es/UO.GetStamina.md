...
Lee la resistencia actual del modelo local.
...
# Lee la resistencia actual del modelo local.
#
# Integer — valor del campo Stamina, no un porcentaje ni un Boolean. Cero puede ser un valor
