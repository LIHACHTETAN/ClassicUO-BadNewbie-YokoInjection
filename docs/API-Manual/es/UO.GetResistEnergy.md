...
Lee el campo de resistencia del jugador actual: energía.
...
- Lee Player.EnergyResistance en el hilo del juego si Player existe y no está destruido; de lo contrario 0. Sin búsqueda de equipo, cálculo de bonos, petición status ni espera. Un fantasma presente no es un Player destruido.
