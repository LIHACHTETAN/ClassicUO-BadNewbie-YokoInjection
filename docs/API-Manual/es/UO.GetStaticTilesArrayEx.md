...
Busca registros Static/Multi/Item por graphic/type en un rectángulo.
...
- `TileTypes` — Array de graphic/type numéricos. Repetir un tipo no duplica registros. También acepta un escalar como tipo único. Un Array vacío busca todos los tipos; un array con solo 0 busca únicamente 0.

## Devuelve

Array de registros [graphic, X, Y, Z, hue], todos Integer. Z es la altura de base, hue el color. Varios registros en una celda se mantienen separados. Sin coincidencias: Array vacío. La cantidad de registros es GetArrayLength(result). Los índices empiezan en 0. No es Boolean, serial ni Pascal record; no existe un séptimo parámetro de salida.
...
- La rama static actual incluye Static, Multi e Item, incluidos objetos cargados en el suelo, pero excluye Land y Mobile. Su alcance supera las estáticas de los archivos.
...
# Busca registros Static/Multi/Item por graphic/type en un rectángulo.
#
# Array de registros [graphic, X, Y, Z, hue], todos Integer. Z es la altura de base, hue el
# color. Varios registros en una celda se mantienen separados. Sin coincidencias: Array vacío.
# La cantidad de registros es GetArrayLength(result). Los índices empiezan en 0. No es Boolean,
# serial ni Pascal record; no existe un séptimo parámetro de salida.
