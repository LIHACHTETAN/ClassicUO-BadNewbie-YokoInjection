...
Legge il contatore status del giocatore attuale: peso attuale in stones.
...
Integer — peso attuale in stones, 0..65535 nel modello. 0 può essere reale, sconosciuto o Player assente/distrutto. Quantità, non Boolean, ID o type: 1 significa un’unità, non successo. Nessuna ricerca oggetti o array restituito.

## Comportamento

- Nessun argomento. Seguire le firme visualizzate.
- Legge Player.Weight nel thread di gioco se Player esiste e non è distrutto; altrimenti 0. Nessuna ricerca nell’equipaggiamento, calcolo bonus, richiesta status o attesa. Un fantasma presente non è un Player distrutto.
- Weight legge il totale in stones riportato dal server. Le regole dello shard stabiliscono il peso incluso di corpo, equipaggiamento e borse annidate. Non percorre contenitori, somma pesi o aggiorna borse chiuse. Non è Weight di un singolo oggetto né numero di items.
...
# Legge il contatore status del giocatore attuale: peso attuale in stones.
#
# Integer — peso attuale in stones, 0..65535 nel modello. 0 può essere reale, sconosciuto o
