...
Legge il campo di resistenza del giocatore attuale: fuoco.
...
- Legge Player.FireResistance nel thread di gioco se Player esiste e non è distrutto; altrimenti 0. Nessuna ricerca nell’equipaggiamento, calcolo bonus, richiesta status o attesa. Un fantasma presente non è un Player distrutto.
