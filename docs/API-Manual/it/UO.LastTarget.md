...
Legge il serial dell’ultimo oggetto bersaglio salvato.
...
Integer — serial/ID, non type o Boolean. 0: nessun bersaglio oggetto; terreno/statici hanno anch’essi serial 0 con possibili coordinate salvate. Conserva tutti i 32 bit. Verificare <> 0, non > 0 né = TRUE.
...
# Legge il serial dell’ultimo oggetto bersaglio salvato.
#
# Integer — serial/ID, non type o Boolean. 0: nessun bersaglio oggetto; terreno/statici hanno
# anch’essi serial 0 con possibili coordinate salvate. Conserva tutti i 32 bit. Verificare <> 0,
# non > 0 né = TRUE.
