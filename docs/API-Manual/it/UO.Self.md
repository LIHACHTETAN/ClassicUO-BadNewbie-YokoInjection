...
Restituisce l’ID del personaggio attuale.
...
Integer — serial/ID, non graphic/type, layer, quantità o Boolean. 0: nessun oggetto attuale. Conserva tutti i 32 bit; verificare <> 0, non = TRUE o > 0. Il risultato salvato non si aggiorna da solo. Legge World.Player.Serial; Player assente/distrutto dà 0. La morte non è distruzione: un fantasma presente mantiene il proprio ID.
...
# aggiorna da solo. Legge World.Player.Serial; Player assente/distrutto dà 0. La morte non è
# distruzione: un fantasma presente mantiene il proprio ID.
