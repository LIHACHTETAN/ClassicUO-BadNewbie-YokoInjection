...
Controlla se un mobile è avvelenato.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Confrontabile con numeri o costanti logiche senza virgolette. 1 indica IsPoisoned sul mobile; altrimenti, o se assente, 0. Intensità e durata residua del veleno non vengono restituite.
...
- Poisoned/Flying dipendono dal protocollo: prima di 7.0.0.0 il bit 0x04 indica veleno; da 7.0.0.0 indica volo e il veleno viene memorizzato separatamente. Il volo non si calcola da Z.
...
1 indica IsPoisoned sul mobile; altrimenti, o se assente, 0. Intensità e durata residua del veleno non vengono restituite.
...
# virgolette. 1 indica IsPoisoned sul mobile; altrimenti, o se assente, 0. Intensità e durata
# residua del veleno non vengono restituite.
#
