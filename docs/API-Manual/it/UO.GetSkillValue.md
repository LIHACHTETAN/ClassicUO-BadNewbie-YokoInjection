...
Legge il valore base dell’abilità senza modificatori.
...
Decimal (Double) — punti abilità in decimi, per esempio 95,1 invece di 951. Il campo BaseFixed viene diviso direttamente per 10 in Double. Zero indica abilità nulla o personaggio/abilità assente. Non Boolean. Le vecchie SkillVal/BaseVal usano una scala diversa; non confondere le famiglie.
...
# Legge il valore base dell’abilità senza modificatori.
#
# Decimal (Double) — punti abilità in decimi, per esempio 95,1 invece di 951. Il campo BaseFixed
