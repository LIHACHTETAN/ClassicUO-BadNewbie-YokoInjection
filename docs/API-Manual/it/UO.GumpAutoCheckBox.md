...
- `CheckBoxID` — Integer — ID esatto del tipo di controllo richiesto. Non è un indice, un GumpID o il serial della finestra. 0 è un ID ordinario, senza selezione automatica del primo elemento.
