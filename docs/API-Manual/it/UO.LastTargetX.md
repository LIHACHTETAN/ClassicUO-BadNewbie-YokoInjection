...
Legge X salvata nell’ultima selezione del bersaglio.
...
Integer — coordinata X salvata, non pixel o Boolean. 0 prima della selezione/dopo Clear o per oggetti ignoti; zero è anche una coordinata valida. Funziona sul terreno/statici con LastTarget()=0.
...
Sorgente del progetto: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; funzione `LastTargetX`.
...
# Legge X salvata nell’ultima selezione del bersaglio.
#
# Integer — coordinata X salvata, non pixel o Boolean. 0 prima della selezione/dopo Clear o per
