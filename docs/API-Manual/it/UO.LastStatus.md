...
Restituisce il serial dell’ultimo oggetto il cui stato è stato accettato dal client.
...
Integer — i 32 bit del serial, non un type né un Boolean. 0 indica nessuno stato accettato o mondo azzerato. Il bit più alto è conservato: anche un numero negativo può rappresentare un serial. Verificare <> 0, non > 0 né = TRUE.
...
# Restituisce il serial dell’ultimo oggetto il cui stato è stato accettato dal client.
#
# Integer — i 32 bit del serial, non un type né un Boolean. 0 indica nessuno stato accettato o
# mondo azzerato. Il bit più alto è conservato: anche un numero negativo può rappresentare un
# serial. Verificare <> 0, non > 0 né = TRUE.
