...
Controlla se un mobile sta volando.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Confrontabile con numeri o costanti logiche senza virgolette. 1 indica IsFlying sul mobile; altrimenti, o se assente, 0. La sola altezza Z non indica il volo.
...
1 indica IsFlying sul mobile; altrimenti, o se assente, 0. La sola altezza Z non indica il volo.
...
# virgolette. 1 indica IsFlying sul mobile; altrimenti, o se assente, 0. La sola altezza Z non
# indica il volo.
#
