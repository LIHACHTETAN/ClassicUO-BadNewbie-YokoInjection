...
Legge la stamina attuale dal modello locale.
...
# Legge la stamina attuale dal modello locale.
#
# Integer — valore del campo Stamina, non una percentuale né un Boolean. Zero può essere reale o
