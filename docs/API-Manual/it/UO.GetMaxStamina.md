...
Legge la stamina massima dal modello locale.
...
# Legge la stamina massima dal modello locale.
#
# Integer — valore del campo StaminaMax, non una percentuale né un Boolean. Zero può essere
# reale o indicare dati assenti. Non dividere per un massimo pari a zero. I valori degli altri
# mobile possono essere sconosciuti. HP/HitsMax possono rappresentare una scala relativa del
# server anziché punti esatti. HP=0 non dimostra la morte; usare Dead/IsDead.
