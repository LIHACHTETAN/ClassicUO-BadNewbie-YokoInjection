...
Legge la quantità attuale del primo risultato.
...
Integer — Amount attuale dell’oggetto indicato da FindItem(); 1 per un personaggio presente, 0 per un oggetto assente/eliminato. Non somma altre pile. Il valore viene letto durante la chiamata.
...
# Legge la quantità attuale del primo risultato.
#
# Integer — Amount attuale dell’oggetto indicato da FindItem(); 1 per un personaggio presente, 0
# per un oggetto assente/eliminato. Non somma altre pile. Il valore viene letto durante la
# chiamata.
