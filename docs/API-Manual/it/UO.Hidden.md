...
Controlla se un mobile è nascosto.
...
- `idText` — Oggetto facoltativo nelle forme mostrate: serial numerico/stringa esadecimale, self, lasttarget o nome AddObject registrato. Non è un type. Se omesso, legge self. Un testo sconosciuto causa un errore di conversione in alcune forme; verificare prima il nome.
...
Integer Boolean: 1 = TRUE, 0 = FALSE. Confrontabile con numeri o costanti logiche senza virgolette. 1 indica IsHidden sul mobile; altrimenti, o se assente, 0. È un flag del server, non la visibilità attraverso i muri.
...
1 indica IsHidden sul mobile; altrimenti, o se assente, 0. È un flag del server, non la visibilità attraverso i muri.
...
# virgolette. 1 indica IsHidden sul mobile; altrimenti, o se assente, 0. È un flag del server,
# non la visibilità attraverso i muri.
#
