...
- `ObjID` — Serial/ID facoltativo del mobile: intero, stringa esadecimale, self, lasttarget, altro alias standard o nome AddObject. Non è graphic/type. Senza argomento viene scelto self. Un alias sconosciuto dà 0; non si apre un cursore di selezione.
