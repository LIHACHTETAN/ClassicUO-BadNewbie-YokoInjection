...
Cerca i record Static/Multi/Item per graphic/type in un rettangolo.
...
- `TileType` — Un graphic/type della tessera, normalmente 0..65535, non un serial. 0 cerca esattamente graphic 0; -1 non è un carattere jolly. Tipo non trovato: risultato vuoto.

## Restituisce

Array di record [graphic, X, Y, Z, hue], tutti Integer. Z è la quota della base, hue il colore. Più record nella stessa cella restano distinti. Nessuna corrispondenza: Array vuoto. Il numero di record è GetArrayLength(result). Gli indici iniziano da 0. Non è Boolean, serial o Pascal record; non esiste un settimo parametro di uscita.
...
- Il ramo static attuale comprende Static, Multi e Item, inclusi gli oggetti caricati a terra, ma esclude Land e Mobile. Include più delle sole statiche dei file.
...
# Cerca i record Static/Multi/Item per graphic/type in un rettangolo.
#
# Array di record [graphic, X, Y, Z, hue], tutti Integer. Z è la quota della base, hue il
# colore. Più record nella stessa cella restano distinti. Nessuna corrispondenza: Array vuoto.
# Il numero di record è GetArrayLength(result). Gli indici iniziano da 0. Non è Boolean, serial
# o Pascal record; non esiste un settimo parametro di uscita.
