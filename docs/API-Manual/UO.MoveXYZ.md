...
### Пример 1. Соседняя клетка на той же высоте
...
### Пример 2. Подойти к точке на нужной высоте и проверить результат
...
### Пример 3. Бег с лимитами и запретом открывать двери
...
### Пример 4. Готовая функция с комментариями внутри скрипта
