...
ClassicUO • Runtime API • `UO.AddRecall.md`
...
- `UO.AddRecall(bookSerial:ObjectRef) -> Unit`
  - **Return type:** `Unit`
...
- `bookSerial` — self/backpack/lasttarget/saved object name or valid decimal/0x serial, according to the overload. 0 only where documented as no-object/clear.
